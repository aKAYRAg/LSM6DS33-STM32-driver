...
float read_data_gyro(int eksen){
	...
	int16_t gyro_raw[3];
	  ...
	  cuffer[0]=0x22;
	  HAL_I2C_Master_Transmit(&hi2c1,(0x6B)<<1,cuffer,1,HAL_MAX_DELAY);
	  HAL_I2C_Master_Receive(&hi2c1,(0x6B)<<1,cuffer,6,HAL_MAX_DELAY);
...
float read_data_acc(int eksen){
	...
	int16_t acc_raw[3];
	  ...
	  buffer[0]=0x28;
	  HAL_I2C_Master_Transmit(&hi2c1,(0x6B)<<1,buffer,1,HAL_MAX_DELAY);
	  HAL_I2C_Master_Receive(&hi2c1,(0x6B)<<1,buffer,6,HAL_MAX_DELAY);
